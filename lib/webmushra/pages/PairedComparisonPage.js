...
PairedComparisonPage.prototype.init = function () {
  ...
  this.mushraAudioControl = new MushraAudioControl(this.audioContext, this.bufferSize, this.reference, [this.condition], this.errorHandler, false, false, true, true);
...
PairedComparisonPage.prototype.render = function (_parent) {
  ...
  if (this.pageConfig.showReference) {
    ...
    tableAB.append("<tr><td>A</td><td>B</td></tr>")
  }
